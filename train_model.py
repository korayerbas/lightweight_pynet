...
def train_model():
    ...
    if level < 4:
        ...
        generator.load_state_dict(torch.load("/content/gdrive/MyDrive/ColabNotebooks/PYNET/results/lght/lght_level_" + str(level+1) +
    ...
    for epoch in range(num_train_epochs):
        ...
        for i in range(len(train_loader)):
            ...
            if i == 0:
                ...
                generator.eval().cpu()
                torch.save(generator.state_dict(), "/content/gdrive/MyDrive/ColabNotebooks/PYNET/results/lght/lght_level_" + str(level) + "_epoch_" + str(epoch) + "_lght.pth")
                ...
                with torch.no_grad():
                    ...
                    for j in range(len(visual_loader)):
                        ...
                        imageio.imwrite("/content/gdrive/MyDrive/ColabNotebooks/PYNET/results/lght/lght_img_" + str(j) + "_level_" + str(level) + "_epoch_" +
